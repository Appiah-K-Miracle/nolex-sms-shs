...
export default function EditSupplierPage() {
  ...
  const [formData, setFormData] = useState(existingSupplier);

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Updated supplier data:", formData);
    // Here you would typically send the data to your backend
    router.push(`/reports/suppliers/${formData.id}`);
  };
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Update supplier information - {formData.name}
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Update supplier location details
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Update any additional information about the supplier
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-2">
