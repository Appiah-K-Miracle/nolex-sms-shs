...
export default function EditExpensePage() {
  ...
  const [formData, setFormData] = useState(existingExpense);

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Handle form submission
    console.log("[v0] Updated expense data:", formData);
    router.push(`/headmaster/reports/expenses/${formData.id}`);
  };
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Update expense information - {formData.id}
                </p>
              </div>
            </div>
              ...
              <div className="grid gap-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Update the basic expense details
                    </CardDescription>
                  </CardHeader>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Update payment and approval details
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Update any additional notes or details
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
