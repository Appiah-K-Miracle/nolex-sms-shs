  ...
  return (
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => router.push("/reports/expenses/add")}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold">GH₵ {totalExpenses.toLocaleString()}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <p className="text-3xl font-bold text-green-600">GH₵ {paidExpenses.toLocaleString()}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <p className="text-3xl font-bold text-orange-600">GH₵ {pendingExpenses.toLocaleString()}</p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>A list of all school expenses</CardDescription>
            </div>
            ...
            <TableBody>
              {filteredExpenses.map((expense) => (
                <TableRow key={expense.id}>
                  ...
                  <TableCell className="font-semibold">GH₵ {expense.amount.toLocaleString()}</TableCell>
                  <TableCell>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => router.push(`/reports/expenses/${expense.id}`)}>
                          <Eye className="w-4 h-4 mr-2" />
                          View Details
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => router.push(`/reports/expenses/${expense.id}/edit`)}>
