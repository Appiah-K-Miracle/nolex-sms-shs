          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="dateOfBirth" name="dateOfBirth" type="date" required defaultValue={student.dateOfBirth} />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="nationality" name="nationality" required defaultValue={student.nationality} />
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="studentId" name="studentId" required defaultValue={student.studentId} disabled />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Select name="class" required defaultValue={student.class}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Select name="program" required defaultValue={student.program}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Select name="residentialStatus" required defaultValue={student.residentialStatus}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <Textarea id="address" name="address" required defaultValue={student.address} rows={3} />
              </div>
            </div>
            ...
            <div className="pt-4 border-t">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="guardianName" name="guardianName" required defaultValue={student.guardianName} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="guardianRelation">Relationship *</Label>
                  <Select name="guardianRelation" required defaultValue={student.guardianRelation}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="guardianEmail" name="guardianEmail" type="email" defaultValue={student.guardianEmail} />
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="allergies" name="allergies" defaultValue={student.allergies} />
              </div>
              <div className="space-y-2 md:col-span-2">
